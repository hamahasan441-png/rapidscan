...
- :heavy_check_mark: Sub-Domains Brute Forcing (_DNSMap, amass, nikto, subfinder_)
...
- :heavy_check_mark: CVE Scanning with Nuclei (_Critical, High, Medium severity_).
- :heavy_check_mark: Subdomain Takeover Detection.
